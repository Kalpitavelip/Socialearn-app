...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center text-center pt-0">

        <h1 className="text-4xl md:text-6xl font-bold text-white-500">
      ...
      {/*feaures section*/}
      <section className="mt-24 md:mt-40 px-10">

        <h2 className= "text-3xl md:text-5xl font-bold text-center text-pink-900">
          Why socialearn?
        </h2>
        ...
        <div className= "grid grid-col-1 md:grid-col-3 gap-8 mt-16">
      ...
      {/* Community Section */}
    <section className="mt-24 md:mt-40 px-10 pb-20">

      <h2 className="text-3xl md:text-5xl font-bold text-center text-pink-500">
        Meet The Community
      </h2>
